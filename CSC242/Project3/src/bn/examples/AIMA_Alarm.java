...
public class AIMA_Alarm {
	...
	public static void main(String[] args) {
		...
		/** Testing with Rejection Sampling**/
		Inferencer reject = new RejectionSampler(100000);
		a = new bn.base.Assignment();
		a.put(J, TRUE);
		a.put(M, TRUE);
		Distribution dist2 = reject.query(B, a, bn);
		System.out.println("R:" + dist2);
		
		/** Testing with Likelihood Weighting**/
		Inferencer weighting = new GibbsSampler(100000);
		a = new bn.base.Assignment();
		a.put(J, TRUE);
		a.put(M, TRUE);
		Distribution dist3 = weighting.query(B, a, bn);
		System.out.println("L:" + dist3);
		
		/** Testing with Gibbs Sampling**/
		Inferencer gibby = new GibbsSampler(100000);
		a = new bn.base.Assignment();
		a.put(J, TRUE);
		a.put(M, TRUE);
		Distribution dist4 = gibby.query(B, a, bn);
		System.out.println("G:" + dist4);
	}
