 ...
 */
extern DFA new_DFA(int nstates, int accepSize);
 ...
 */
//extern void DFA_set_transition(DFA dfa, int trans[dfa->nstates][128], int src, char sym, int dst);
 ...
 */
extern int DFA_execute(DFA dfa, int inputlen, char input[inputlen]);
