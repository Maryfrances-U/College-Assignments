/* Course: CSCI 450, Section 1
 ...
 In keeping with the Honor Code of UM, I have neither given nor received assistance from anyone other than the TA or the instructor.
 Program Description: Finish a lexical analysis program.
*/
...
//GETNONBLANK
//Afunction to call getChar until it returns a non-whitespace character
void getNonBlank() {
